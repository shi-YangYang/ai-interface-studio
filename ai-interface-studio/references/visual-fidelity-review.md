...
- Approved page mockups in reading order
...
5. Compare reference and implementation side by side, region by region.
6. Record differences before judging pass or fail.
7. Re-run the full affected-page review after fixes; do not verify only the edited component.
...
3. Components: type, count, placement, size, variants, controls, charts, tables, cards
4. Typography: family category, scale hierarchy, weight, line height, alignment
5. Visual tokens: palette, borders, radii, shadows, dividers, icon treatment
6. Density and rhythm: spacing, row height, card padding, content amount
7. Responsive transformation and scroll behavior
8. Content and state fidelity according to `uiux-design.md`
...
- **Blocker**: wrong page composition or theme, missing major region, incorrect navigation shell, unusable layout, or implementation clearly resembles a different design.
- **Major**: wrong column ratio, component type, placement, typography hierarchy, palette, spacing density, responsive behavior, or repeated style pattern.
